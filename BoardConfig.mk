TARGET_BOARD_INFO_FILE := device/nexell/s5p6818_avn_ref_bt/board-info.txt


TARGET_BOARD_PLATFORM 		 := slsiap
TARGET_BOOTLOADER_BOARD_NAME := s5p6818_avn_ref_bt
...
# recovery
TARGET_RECOVERY_FSTAB := device/nexell/s5p6818_avn_ref_bt/recovery.fstab

TARGET_RELEASETOOLS_EXTENSIONS := device/nexell/s5p6818_avn_ref_bt
TARGET_RECOVERY_UPDATER_LIBS += librecovery_updater_s5p6818_avn_ref_bt
